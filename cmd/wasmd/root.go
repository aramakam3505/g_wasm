...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	cfg := sdk.GetConfig()
	cfg.SetBech32PrefixForAccount("gemma", "gemma")
	cfg.SetBech32PrefixForValidator("gemmaval", "gemmaval")
	cfg.SetBech32PrefixForConsensusNode("gemmavalcons", "gemmavalcons")
